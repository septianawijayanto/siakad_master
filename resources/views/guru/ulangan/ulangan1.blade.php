...
@section('heading', 'Entry Nilai Ulangan Harian 1')
@section('page')
<li class="breadcrumb-item active">Entry Nilai Ulangan Harian 1</li>
@endsection
@section('content')
<div class="col-md-12">
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Entry Nilai Ulangan Harian 1</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <div class="row">
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th class="ctr">No.</th>
                                <th>Nama Siswa</th>
                                <th class="ctr">Nilai Ulangan Harian 1</th>
